...
(function() {
  $(function() {
    var JUDGE_ALREADY, JUDGE_NG, JUDGE_OK, add_list, all_word_num, ans_form, btn_answer, btn_end, btn_start, btn_tweet, data_start_id, dtime, favorite, game_end, game_flag, game_id, game_mode, game_name, game_start, game_start_open, generate_tag_check_span, get_forms, input_game_name, input_tag_form, my_disp, my_disp_down, name_check, post_result, process_count_span, replay, solve_count, start_time, stc, tag_check_box, td_boxs, time_box, timer_btn, timer_id, timer_input, timer_input_val, timer_mode, to_ans_kana, to_double0, to_time_str, to_time_str_r, turn_off, word_boxs, word_unit, wordbox_change, wordbox_clear;
