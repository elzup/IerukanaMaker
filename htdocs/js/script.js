...
(function() {
  $(function() {
    var add_list, all_word_num, btn_end, btn_start, data_start_id, dtime, form, game_end, game_flag, game_id, game_start, get_forms, my_disp, post_result, process_count_span, replay, solve_count, start_time, td_boxs, time_box, timer_id, to_double0, word_boxs, wordbox_change, wordbox_clear;
