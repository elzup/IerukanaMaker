...
(function() {
  $(function() {
    var add_list, all_word_num, ans_form, btn_answer, btn_end, btn_start, btn_tweet, data_start_id, dtime, game_end, game_flag, game_id, game_mode, game_name, game_start, game_start_open, get_forms, input_game_name, my_disp, my_disp_down, name_check, post_result, process_count_span, replay, solve_count, start_time, stc, td_boxs, time_box, timer_btn, timer_id, timer_input, timer_mode, to_ans_kana, to_double0, to_time_str, word_boxs, word_unit, wordbox_change, wordbox_clear;
    ...
    get_forms = function() {
      var data, game_description, game_tags, wordlist, words_text, words_unit;
      wordlist = [];
      word_boxs.each(function() {
        var v;
        v = $.trim($(this).val());
    ...
    return timer_btn.click(function() {
